import { LayoutDashboard, CalendarDays, TrendingUp, ChevronLeft, ChevronRight, Settings, Upload, Users, User, Shield, LogOut } from "lucide-react";
          ...
          <NavLink to="/perfil" className="flex items-center gap-2 min-w-0 hover:opacity-80 transition-opacity">
            ...
            {!isCollapsed && (
              <div className="flex flex-col min-w-0 animate-fade-in">
                ...
                <span className="text-[10px] text-muted-foreground capitalize">Administrador</span>
              </div>
            )}
          </NavLink>
          {!isCollapsed && (
